  ...
  $(function () {
    ...
    */
    $(document).on('facetwp-loaded', function () {
      ...
      if (facets) {
        ...
        document.cookie = 'vehicle=' + vehicle + '; expires=' + date.toGMTString() + '; path=/'; // update the your vehicle with facet selection
      ...
      } else {} // hide all our buttons and categories if no facets loaded
    ...
    */
    ...
    $(document).on('facetwp-refresh', function () {
      ...
      console.log(isMobile); // un hide categories and buttons if we have facets
