    ...
    <div class="nav-wrapper bg-primary d-none d-lg-block border-top">
        <div class="container">
            ...
            <ul class="nav nav-fill justify-content-between">
                ...
                <li>
                    <a role="button" class="nav-link text-white" id="mobile-nav-link" data-bs-toggle="offcanvas"
                        href="#off-canvas-mobile-nav" role="button" aria-controls="off-canvas-mobile-nav">
                        Mobile Nav
                    </a>
                </li>
                <li>
