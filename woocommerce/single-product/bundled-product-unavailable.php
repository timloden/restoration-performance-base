...
?><div class="cart unavailable_item" data-title="<?php echo esc_attr( $bundled_item->get_title() ); ?>"
    data-product_variations="<?php echo htmlspecialchars( json_encode( array() ) ); ?>"
    ...
    data-type="<?php echo $bundled_item->get_product()->get_type(); ?>"
    data-bundled_item_id="<?php echo $bundled_item->get_id(); ?>"
    data-custom_data="<?php echo esc_attr( json_encode( $custom_product_data ) ); ?>"
    data-product_id="<?php echo $bundled_item->get_product()->get_id(); ?>"
        ...
        <div class="bundled_item_cart_content">
            <div class="bundled_item_cart_details">
                ...
                <p class="limited-subscription-notice notice">
                    <?php esc_html_e( 'You have an active subscription to this product already.', 'woocommerce-subscriptions' ); ?>
                </p><?php
					}
				?></p>
            </div>
