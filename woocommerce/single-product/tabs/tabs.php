...
if ( ! empty( $product_tabs ) ) : ?>
	...
	<div class="woocommerce-tabs wc-tabs-wrapper">
		<ul class="nav nav-tabs" role="tablist">
			<?php foreach ( $product_tabs as $key => $product_tab ) : $count++; ?>
		...
		<div class="tab-content" id="nav-tabContent">
			...
			foreach ( $product_tabs as $key => $product_tab ) : $count++; ?>
				<div class="tab-pane fade <?php if ($count == 1) { echo 'show active'; } ?>" id="tab-<?php echo esc_attr( $key ); ?>" role="tabpanel" aria-labelledby="tab-title-<?php echo esc_attr( $key ); ?>">
					<?php
