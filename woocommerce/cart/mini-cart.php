        ...
        <li
            ...
            <div class="row g-3">
                ...
                <div class="col-9">
                    <p class="mb-0">
                        <a
                            href="<?php echo esc_url($product_permalink); ?>"><?php echo wc_get_formatted_cart_item_data($cart_item);
...
<div class="mini-cart-footer p-2 border-top bg-light">
    <p class="woocommerce-mini-cart__total total px-2 text-center">
        <?php
        /**
    ...
    <div class="woocommerce-mini-cart__buttons buttons row g-2">
    ...
    <p class="woocommerce-mini-cart__empty-message p-2"><?php esc_html_e('No products in the cart.', 'woocommerce'); ?>
    </p>
