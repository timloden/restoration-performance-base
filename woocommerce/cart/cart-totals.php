...
<div class="cart_totals <?php echo ( WC()->customer->has_calculated_shipping() ) ? 'calculated_shipping' : ''; ?>">
    ...
    <table cellspacing="0" class="shop_table shop_table_responsive table">
        ...
        <tr class="cart-subtotal">
            ...
            <td class="text-right" data-title="<?php esc_attr_e( 'Subtotal', 'woocommerce' ); ?>">
        ...
        <tr class="shipping">
            ...
            <td class="text-right" data-title="<?php esc_attr_e( 'Shipping', 'woocommerce' ); ?>">
        ...
        <tr class="fee">
            ...
            <td class="text-right" data-title="<?php echo esc_attr( $fee->name ); ?>">
        ...
        <tr class="tax-rate tax-rate-<?php echo esc_attr( sanitize_title( $code ) ); ?>">
            ...
            <td class="text-right" data-title="<?php echo esc_attr( $tax->label ); ?>">
        ...
        <tr class="tax-total">
            <th>
                ...
                <br><span class="font-weight-light" style="font-size: 12px;">(if required)</span>
            </th>
            <td class="text-right" data-title="<?php echo esc_attr( WC()->countries->tax_or_vat() ); ?>">
